package com.example.database_sekolah.Adapter;
...
import com.example.database_sekolah.Edit_data;
import com.example.database_sekolah.Entity.DataSekolah;
import com.example.database_sekolah.R;
import com.example.database_sekolah.MainContact;
...
public class SekolahAdapter extends RecyclerView.Adapter<SekolahAdapter.ViewHolder> {
    ...
    public SekolahAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.lihat_data, viewGroup, false);
